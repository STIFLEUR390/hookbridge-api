...
class CreateIncomingRequestRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'http_method' => ['required', 'string', Rule::in(['GET', 'POST', 'PUT', 'DELETE', 'PATCH'])],
    ...
    {
        return [
            'project_id.required' => __('api.required', ['attribute' => __('incoming_requests.attributes.project_id')]),
            'project_id.exists' => __('api.validation.exists', ['attribute' => __('incoming_requests.attributes.project_id')]),
            'type.required' => __('api.required', ['attribute' => __('incoming_requests.attributes.type')]),
            ...
            'http_method.required' => __('api.required', ['attribute' => __('incoming_requests.attributes.http_method')]),
            ...
            'status.required' => __('api.required', ['attribute' => __('incoming_requests.attributes.status')]),
            ...
            'received_at.required' => __('api.required', ['attribute' => __('incoming_requests.attributes.received_at')]),
