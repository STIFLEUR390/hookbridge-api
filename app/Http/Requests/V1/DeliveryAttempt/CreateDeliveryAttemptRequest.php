...
class CreateDeliveryAttemptRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'status' => ['required', 'string', Rule::in(['pending', 'success', 'failed'])],
    ...
    {
        return [
            'incoming_request_id.required' => __('api.required', ['attribute' => __('delivery_attempts.attributes.incoming_request_id')]),
            'incoming_request_id.exists' => __('api.validation.exists', ['attribute' => __('delivery_attempts.attributes.incoming_request_id')]),
            'project_target_id.required' => __('api.required', ['attribute' => __('delivery_attempts.attributes.project_target_id')]),
            'project_target_id.exists' => __('api.validation.exists', ['attribute' => __('delivery_attempts.attributes.project_target_id')]),
            'status.required' => __('api.required', ['attribute' => __('delivery_attempts.attributes.status')]),
            ...
            'attempted_at.required' => __('api.required', ['attribute' => __('delivery_attempts.attributes.attempted_at')]),
