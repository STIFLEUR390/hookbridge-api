...
return [
    ...
    'password'               => [
        ...
        'mixed'         => 'این فیلد باید حداقل شامل یک حرف بزرگ و یک حرف کوچک باشد.',
        'numbers'       => 'این فیلد باید حداقل شامل یک عدد باشد.',
        'symbols'       => 'این فیلد باید حداقل شامل یک کارکتر خاص باشد.',
        'uncompromised' => 'فیلد داده شده در نشت داده ظاهر شده است. لطفاً یک فیلد متفاوت انتخاب کنید.',
    ],
