...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Repositories\V1\DeliveryAttempt\DeliveryAttemptRepositoryInterface' => \App\Repositories\V1\DeliveryAttempt\DeliveryAttemptRepository::class,
            'App\Repositories\V1\IncomingRequest\IncomingRequestRepositoryInterface' => \App\Repositories\V1\IncomingRequest\IncomingRequestRepository::class,
            'App\Repositories\V1\ProjectTarget\ProjectTargetRepositoryInterface' => \App\Repositories\V1\ProjectTarget\ProjectTargetRepository::class,
            'App\Repositories\V1\Project\ProjectRepositoryInterface' => \App\Repositories\V1\Project\ProjectRepository::class,
            ...
            'Illuminate\Contracts\Debug\ExceptionHandler' => \Essa\APIToolKit\Exceptions\Handler::class,
    ...
    override(\config(), map([
            'api-tool-kit.default_generates' => 'array',
            'api-tool-kit.default_pagination_number' => 'integer',
            'api-tool-kit.datetime_format' => 'string',
            'api-tool-kit.default_group' => 'string',
            'api-tool-kit.groups_files_paths.default.model.folder_path' => 'string',
            'api-tool-kit.groups_files_paths.default.model.file_name' => 'string',
            'api-tool-kit.groups_files_paths.default.model.namespace' => 'string',
            'api-tool-kit.groups_files_paths.default.factory.folder_path' => 'string',
            'api-tool-kit.groups_files_paths.default.factory.file_name' => 'string',
            'api-tool-kit.groups_files_paths.default.factory.namespace' => 'string',
            'api-tool-kit.groups_files_paths.default.seeder.folder_path' => 'string',
            'api-tool-kit.groups_files_paths.default.seeder.file_name' => 'string',
            'api-tool-kit.groups_files_paths.default.seeder.namespace' => 'string',
            'api-tool-kit.groups_files_paths.default.controller.folder_path' => 'string',
            'api-tool-kit.groups_files_paths.default.controller.file_name' => 'string',
            'api-tool-kit.groups_files_paths.default.controller.namespace' => 'string',
            'api-tool-kit.groups_files_paths.default.resource.folder_path' => 'string',
            'api-tool-kit.groups_files_paths.default.resource.file_name' => 'string',
            'api-tool-kit.groups_files_paths.default.resource.namespace' => 'string',
            'api-tool-kit.groups_files_paths.default.test.folder_path' => 'string',
            'api-tool-kit.groups_files_paths.default.test.file_name' => 'string',
            'api-tool-kit.groups_files_paths.default.test.namespace' => 'string',
            'api-tool-kit.groups_files_paths.default.create-request.folder_path' => 'string',
            'api-tool-kit.groups_files_paths.default.create-request.file_name' => 'string',
            'api-tool-kit.groups_files_paths.default.create-request.namespace' => 'string',
            'api-tool-kit.groups_files_paths.default.update-request.folder_path' => 'string',
            'api-tool-kit.groups_files_paths.default.update-request.file_name' => 'string',
            'api-tool-kit.groups_files_paths.default.update-request.namespace' => 'string',
            'api-tool-kit.groups_files_paths.default.filter.folder_path' => 'string',
            'api-tool-kit.groups_files_paths.default.filter.file_name' => 'string',
            'api-tool-kit.groups_files_paths.default.filter.namespace' => 'string',
            'api-tool-kit.groups_files_paths.default.migration.folder_path' => 'string',
            'api-tool-kit.groups_files_paths.default.migration.file_name' => 'string',
            'api-tool-kit.groups_files_paths.default.migration.namespace' => 'NULL',
            'api-tool-kit.groups_files_paths.default.routes.folder_path' => 'string',
            'api-tool-kit.groups_files_paths.default.routes.file_name' => 'string',
            'api-tool-kit.groups_files_paths.default.routes.namespace' => 'NULL',
            'api-tool-kit.groups_files_paths.v1.model.folder_path' => 'string',
            'api-tool-kit.groups_files_paths.v1.model.file_name' => 'string',
            'api-tool-kit.groups_files_paths.v1.model.namespace' => 'string',
            'api-tool-kit.groups_files_paths.v1.factory.folder_path' => 'string',
            'api-tool-kit.groups_files_paths.v1.factory.file_name' => 'string',
            'api-tool-kit.groups_files_paths.v1.factory.namespace' => 'string',
            'api-tool-kit.groups_files_paths.v1.seeder.folder_path' => 'string',
            'api-tool-kit.groups_files_paths.v1.seeder.file_name' => 'string',
            'api-tool-kit.groups_files_paths.v1.seeder.namespace' => 'string',
            'api-tool-kit.groups_files_paths.v1.controller.folder_path' => 'string',
            'api-tool-kit.groups_files_paths.v1.controller.file_name' => 'string',
            'api-tool-kit.groups_files_paths.v1.controller.namespace' => 'string',
            'api-tool-kit.groups_files_paths.v1.resource.folder_path' => 'string',
            'api-tool-kit.groups_files_paths.v1.resource.file_name' => 'string',
            'api-tool-kit.groups_files_paths.v1.resource.namespace' => 'string',
            'api-tool-kit.groups_files_paths.v1.test.folder_path' => 'string',
            'api-tool-kit.groups_files_paths.v1.test.file_name' => 'string',
            'api-tool-kit.groups_files_paths.v1.test.namespace' => 'string',
            'api-tool-kit.groups_files_paths.v1.create-request.folder_path' => 'string',
            'api-tool-kit.groups_files_paths.v1.create-request.file_name' => 'string',
            'api-tool-kit.groups_files_paths.v1.create-request.namespace' => 'string',
            'api-tool-kit.groups_files_paths.v1.update-request.folder_path' => 'string',
            'api-tool-kit.groups_files_paths.v1.update-request.file_name' => 'string',
            'api-tool-kit.groups_files_paths.v1.update-request.namespace' => 'string',
            'api-tool-kit.groups_files_paths.v1.filter.folder_path' => 'string',
            'api-tool-kit.groups_files_paths.v1.filter.file_name' => 'string',
            'api-tool-kit.groups_files_paths.v1.filter.namespace' => 'string',
            'api-tool-kit.groups_files_paths.v1.migration.folder_path' => 'string',
            'api-tool-kit.groups_files_paths.v1.migration.file_name' => 'string',
            'api-tool-kit.groups_files_paths.v1.migration.namespace' => 'NULL',
            'api-tool-kit.groups_files_paths.v1.routes.folder_path' => 'string',
            'api-tool-kit.groups_files_paths.v1.routes.file_name' => 'string',
            'api-tool-kit.groups_files_paths.v1.routes.namespace' => 'NULL',
            'api-tool-kit.groups_url_prefixes.default' => 'string',
            'api-tool-kit.groups_url_prefixes.v1' => 'string',
            'app.name' => 'string',
            'app.env' => 'string',
            'app.debug' => 'boolean',
            'app.url' => 'string',
            ...
            'filesystems.links.C:\Users\Aplix\Herd\hookbridge\public\storage' => 'string',
            ...
            'api-tool-kit-internal.api_generator_commands.model' => 'string',
            'api-tool-kit-internal.api_generator_commands.factory' => 'string',
            'api-tool-kit-internal.api_generator_commands.seeder' => 'string',
            'api-tool-kit-internal.api_generator_commands.controller' => 'string',
            'api-tool-kit-internal.api_generator_commands.resource' => 'string',
            'api-tool-kit-internal.api_generator_commands.test' => 'string',
            'api-tool-kit-internal.api_generator_commands.create-request' => 'string',
            'api-tool-kit-internal.api_generator_commands.update-request' => 'string',
            'api-tool-kit-internal.api_generator_commands.filter' => 'string',
            'api-tool-kit-internal.api_generator_commands.migration' => 'string',
            'api-tool-kit-internal.api_generator_commands.routes' => 'string',
            'api-tool-kit-internal.filters.handlers' => 'array',
...
'api-tool-kit.default_generates','api-tool-kit.default_pagination_number','api-tool-kit.datetime_format','api-tool-kit.default_group','api-tool-kit.groups_files_paths.default.model.folder_path',
'api-tool-kit.groups_files_paths.default.model.file_name','api-tool-kit.groups_files_paths.default.model.namespace','api-tool-kit.groups_files_paths.default.factory.folder_path','api-tool-kit.groups_files_paths.default.factory.file_name','api-tool-kit.groups_files_paths.default.factory.namespace',
'api-tool-kit.groups_files_paths.default.seeder.folder_path','api-tool-kit.groups_files_paths.default.seeder.file_name','api-tool-kit.groups_files_paths.default.seeder.namespace','api-tool-kit.groups_files_paths.default.controller.folder_path','api-tool-kit.groups_files_paths.default.controller.file_name',
'api-tool-kit.groups_files_paths.default.controller.namespace','api-tool-kit.groups_files_paths.default.resource.folder_path','api-tool-kit.groups_files_paths.default.resource.file_name','api-tool-kit.groups_files_paths.default.resource.namespace','api-tool-kit.groups_files_paths.default.test.folder_path',
'api-tool-kit.groups_files_paths.default.test.file_name','api-tool-kit.groups_files_paths.default.test.namespace','api-tool-kit.groups_files_paths.default.create-request.folder_path','api-tool-kit.groups_files_paths.default.create-request.file_name','api-tool-kit.groups_files_paths.default.create-request.namespace',
'api-tool-kit.groups_files_paths.default.update-request.folder_path','api-tool-kit.groups_files_paths.default.update-request.file_name','api-tool-kit.groups_files_paths.default.update-request.namespace','api-tool-kit.groups_files_paths.default.filter.folder_path','api-tool-kit.groups_files_paths.default.filter.file_name',
'api-tool-kit.groups_files_paths.default.filter.namespace','api-tool-kit.groups_files_paths.default.migration.folder_path','api-tool-kit.groups_files_paths.default.migration.file_name','api-tool-kit.groups_files_paths.default.migration.namespace','api-tool-kit.groups_files_paths.default.routes.folder_path',
'api-tool-kit.groups_files_paths.default.routes.file_name','api-tool-kit.groups_files_paths.default.routes.namespace','api-tool-kit.groups_files_paths.v1.model.folder_path','api-tool-kit.groups_files_paths.v1.model.file_name','api-tool-kit.groups_files_paths.v1.model.namespace',
'api-tool-kit.groups_files_paths.v1.factory.folder_path','api-tool-kit.groups_files_paths.v1.factory.file_name','api-tool-kit.groups_files_paths.v1.factory.namespace','api-tool-kit.groups_files_paths.v1.seeder.folder_path','api-tool-kit.groups_files_paths.v1.seeder.file_name',
'api-tool-kit.groups_files_paths.v1.seeder.namespace','api-tool-kit.groups_files_paths.v1.controller.folder_path','api-tool-kit.groups_files_paths.v1.controller.file_name','api-tool-kit.groups_files_paths.v1.controller.namespace','api-tool-kit.groups_files_paths.v1.resource.folder_path',
'api-tool-kit.groups_files_paths.v1.resource.file_name','api-tool-kit.groups_files_paths.v1.resource.namespace','api-tool-kit.groups_files_paths.v1.test.folder_path','api-tool-kit.groups_files_paths.v1.test.file_name','api-tool-kit.groups_files_paths.v1.test.namespace',
'api-tool-kit.groups_files_paths.v1.create-request.folder_path','api-tool-kit.groups_files_paths.v1.create-request.file_name','api-tool-kit.groups_files_paths.v1.create-request.namespace','api-tool-kit.groups_files_paths.v1.update-request.folder_path','api-tool-kit.groups_files_paths.v1.update-request.file_name',
'api-tool-kit.groups_files_paths.v1.update-request.namespace','api-tool-kit.groups_files_paths.v1.filter.folder_path','api-tool-kit.groups_files_paths.v1.filter.file_name','api-tool-kit.groups_files_paths.v1.filter.namespace','api-tool-kit.groups_files_paths.v1.migration.folder_path',
'api-tool-kit.groups_files_paths.v1.migration.file_name','api-tool-kit.groups_files_paths.v1.migration.namespace','api-tool-kit.groups_files_paths.v1.routes.folder_path','api-tool-kit.groups_files_paths.v1.routes.file_name','api-tool-kit.groups_files_paths.v1.routes.namespace',
'api-tool-kit.groups_url_prefixes.default','api-tool-kit.groups_url_prefixes.v1','app.name','app.env','app.debug',
...
'filesystems.disks.s3.report','filesystems.links.C:\\Users\\Aplix\\Herd\\hookbridge\\public\\storage','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'ide-helper.macroable_traits','localization.inline','localization.align','localization.aliases','localization.smart_punctuation.enable',
'localization.smart_punctuation.common.double_quote_opener','localization.smart_punctuation.common.double_quote_closer','localization.smart_punctuation.common.single_quote_opener','localization.smart_punctuation.common.single_quote_closer','localization.smart_punctuation.locales.fr.double_quote_opener',
'localization.smart_punctuation.locales.fr.double_quote_closer','localization.smart_punctuation.locales.fr.single_quote_opener','localization.smart_punctuation.locales.fr.single_quote_closer','localization.smart_punctuation.locales.ru.double_quote_opener','localization.smart_punctuation.locales.ru.double_quote_closer',
'localization.smart_punctuation.locales.ru.single_quote_opener','localization.smart_punctuation.locales.ru.single_quote_closer','localization.smart_punctuation.locales.uk.double_quote_opener','localization.smart_punctuation.locales.uk.double_quote_closer','localization.smart_punctuation.locales.uk.single_quote_opener',
'localization.smart_punctuation.locales.uk.single_quote_closer','localization.smart_punctuation.locales.be.double_quote_opener','localization.smart_punctuation.locales.be.double_quote_closer','localization.smart_punctuation.locales.be.single_quote_opener','localization.smart_punctuation.locales.be.single_quote_closer',
'localization.routes.names.parameter','localization.routes.names.header','localization.routes.names.cookie','localization.routes.names.session','localization.routes.names.column',
'localization.routes.name_prefix','localization.routes.redirect_default','localization.routes.group.middlewares.default','localization.routes.group.middlewares.prefix','localization.models.suffix',
'localization.models.filter.enabled','localization.models.helpers','localization.translators.channels.google.translator','localization.translators.channels.google.enabled','localization.translators.channels.google.priority',
'localization.translators.channels.deepl.translator','localization.translators.channels.deepl.enabled','localization.translators.channels.deepl.priority','localization.translators.channels.deepl.credentials.key','localization.translators.channels.yandex.translator',
'localization.translators.channels.yandex.enabled','localization.translators.channels.yandex.priority','localization.translators.channels.yandex.credentials.key','localization.translators.channels.yandex.credentials.folder','localization.translators.options.preserve_parameters',
...
'scramble.ui.try_it_credentials_policy','scramble.servers','scramble.enum_cases_description_strategy','scramble.middleware','scramble.extensions',
...
'session.http_only','session.same_site','session.partitioned','concurrency.default','cors.paths',
...
'hashing.rehash_on_login','view.paths','view.compiled','api-tool-kit-internal.api_generator_commands.model','api-tool-kit-internal.api_generator_commands.factory',
'api-tool-kit-internal.api_generator_commands.seeder','api-tool-kit-internal.api_generator_commands.controller','api-tool-kit-internal.api_generator_commands.resource','api-tool-kit-internal.api_generator_commands.test','api-tool-kit-internal.api_generator_commands.create-request',
'api-tool-kit-internal.api_generator_commands.update-request','api-tool-kit-internal.api_generator_commands.filter','api-tool-kit-internal.api_generator_commands.migration','api-tool-kit-internal.api_generator_commands.routes','api-tool-kit-internal.filters.handlers',
...
'signed','throttle','verified','validate.project.uuid',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','projects.index','projects.store','projects.show','projects.update',
'projects.destroy','project-targets.index','project-targets.store','project-targets.show',
'project-targets.update','project-targets.destroy','incoming-requests.index','incoming-requests.show','deliveryAttempts.index','deliveryAttempts.show',
'hook.callback','hook.webhook','storage.local',
'scramble.docs.ui','scramble.docs.document',);
        registerArgumentsSet('views', 
'welcome','laradumps::output','laradumps::summary','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'pagination::simple-default','pagination::simple-tailwind','pagination::tailwind','scramble::docs',);
        registerArgumentsSet('translations', 
'auth.failed','auth.password','auth.throttle','auth.login_failed','auth.login_success',
'auth.logout_all_success','auth.logout_success','auth.token_invalid','auth.token_refreshed','auth.unauthenticated',
'auth.unauthorized','pagination.previous','pagination.next','passwords.reset','passwords.sent',
...
'en.0','actions.accept','actions.action','actions.actions','actions.add',
...
'api.success','api.created','api.updated','api.deleted','api.status_changed',
'api.not_found','api.bad_request','api.unauthorized','api.forbidden','api.validation_error',
'api.server_error','api.required','api.email','api.min','api.max',
'api.unique','api.pagination.first','api.pagination.last','api.pagination.next','api.pagination.previous',
...
'http-statuses.598','http-statuses.599','http-statuses.unknownError','project_targets.created','project_targets.updated',
'project_targets.deleted','project_targets.status_activated','project_targets.status_deactivated','project_targets.not_found','project_targets.already_exists',
'project_targets.attributes.project_id','project_targets.attributes.type','project_targets.attributes.url','project_targets.attributes.is_active','project_targets.types.webhook',
'project_targets.types.callback','projects.created','projects.updated','projects.deleted','projects.status_activated',
'projects.status_deactivated','projects.not_found','projects.already_exists','projects.attributes.name','projects.attributes.description',
'projects.attributes.is_active','fr.0',);
